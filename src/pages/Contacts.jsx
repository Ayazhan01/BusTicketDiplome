...
// import MapSeaction from '../components/MapSection';
    ...
    <div className="min-h-screen ">
      ...
      <div className="relative h-screen w-full bg-gray-50 flex flex-col pb-20">
        <div className="flex-1 relative bg-gray-200">
          ...
          <div className="absolute top-30 left-20 z-10 w-96 bg-white/90 backdrop-blur-sm rounded-xl shadow-xl p-5 border border-gray-200">

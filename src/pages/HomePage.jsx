      ...
      {searchResults && (
        ...
        <img src="public/transition.png" className="rotate-180" />
          <section className="w-2/4 my-5 mx-auto">
            <h2 className="text-3xl md:text-6xl font-bold mb-4 text-center flex flex-col items-center space-y-3 uppercase">Найденные <span className="text-red-500">автобусы</span></h2>

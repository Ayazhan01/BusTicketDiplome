  ...
  return (
    <div className="min-h-screen bg-white flex flex-col space-y-30">
      <section className="flex items-center justify-between md:px-20">
        ...
        >
          <h1 className="text-3xl md:text-6xl font-bold text-center flex flex-col items-center space-y-3 uppercase">
            <IoTicketOutline />
        ...
        <>
          <div className="bg-gray-100">
            ...
            <section className="w-2/4 my-5 mx-auto">
              <h2 className="text-3xl md:text-6xl font-bold mb-4 text-center flex flex-col items-center space-y-3 uppercase">
                Найденные <span className="text-red-500">автобусы</span>
              </h2>
              {searchResults.length === 0 ? (
                <div className="text-center py-8">
                  <p className="text-gray-600">
                    Автобусов по вашему запросу не найдено
                  </p>
                </div>
              ) : (
                <div className="space-y-7">
                  {searchResults.map((bus) => (
                    ...
                    >
                      ...
                      <button
                        className="mt-4 w-full py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg transition-colors duration-300"
